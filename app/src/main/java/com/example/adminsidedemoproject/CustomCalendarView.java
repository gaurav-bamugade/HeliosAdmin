...
import com.example.adminsidedemoproject.Adapter.EventRecyclerView;
import com.example.adminsidedemoproject.Adapter.GridAdapter;
import com.example.adminsidedemoproject.Model.AttendanceReportData;
import com.example.adminsidedemoproject.Model.EventsModelClass;
import com.example.adminsidedemoproject.Model.GetAttendanceColor;
import com.example.adminsidedemoproject.Model.LeaveDateModel;
    ...
    public CustomCalendarView(Context context, @Nullable AttributeSet attrs) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TextView EventTime = addView.findViewById(R.id.eventsingletime);

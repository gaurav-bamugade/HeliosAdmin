...
import com.example.adminsidedemoproject.Adapter.AttendanceReportAdapter;
import com.example.adminsidedemoproject.Adapter.LeaveReportAdapter;
    ...
    public void loaduserName()
    {
        ...
        firedb.child("Admin").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                employeeName.setText("Employee Name : " + userName);
            }

...
import com.example.adminsidedemoproject.Adapter.GroupChatListAdapter;
import com.example.adminsidedemoproject.Adapter.PartyNamesAdapter;
import com.example.adminsidedemoproject.Model.GroupChatsList;
...
ImageButton upcoming_img_arrow1,close_dialogue_top_button_create_group;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       fireAuth=FirebaseAuth.getInstance();
        ...
        search_cardView=vi.findViewById(R.id.search_card_group);
    ...
    private void setAddGroupDialog() {
        ...
        close_dialogue_top_button_create_group=groupAddDialogue.findViewById(R.id.close_dialogue_top_button_create_group);
        close_dialogue_top_button_create_group.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                groupAddDialogue.dismiss();
            }
        });

...
import com.example.adminsidedemoproject.Adapter.singleConvoAdapter;
import com.example.adminsidedemoproject.Model.Messages;
...
public class SingleChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      displayUserLastSeen();
        ...
        sendFilesButton=findViewById(R.id.group_attachment);
...
public class SingleChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserMessageList.setAdapter(messageAdapter);
        userName.setText(messageReceiverName);
        //Picasso.get().load(messageReceiverImage).placeholder(R.drawable.adminicon).into(userImage);
        SendMessageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {

...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private DatabaseReference firedb,fireAdmin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fireAdmin= FirebaseDatabase.getInstance().getReference();
       ...
       // Toast.makeText(this, ""+radioButton.getText(), Toast.LENGTH_SHORT).show();
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch(checkedId) {
                    case(R.id.user_profile_details_radioM):
                        gender="Male";
                        break;
                    case(R.id.user_profile_details_radioF):
                        gender="Female";
                        break;
                }
            }
        ...
        firedb.child("ExistingUsers").child(currentuserid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()&&(dataSnapshot.hasChild("UserDob")) )
                {
                    ...
                    if(dbcurrentuserdob.equals(""))
                    {
                       // Toast.makeText(EditProfileActivity.this, "DOB not exist", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                    ...
                    if(task.isSuccessful())
                    {
                        ...
                        firedb.child("ExistingUsers").child(currentuserid).updateChildren(profileImgwithGallery).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                     HashMap<String,Object> adminimg = new HashMap<>();
                                    adminimg.put("AdminImage",myUrl);
                                    fireAdmin.child("Admin").updateChildren(adminimg).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
    ...
    public void uploadWithimg( )
    {
        ...
        firedb.child("ExistingUsers").child(currentuserid).updateChildren(profileImageWithCam).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    HashMap<String,Object> adminimg = new HashMap<>();
                    adminimg.put("AdminImage",downloadUrl);
                    fireAdmin.child("Admin").updateChildren(adminimg).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(EditProfileActivity.this,"Profile updated successfully",Toast.LENGTH_SHORT).show();
            ...
            firedb.child("ExistingUsers").child(currentuserid).updateChildren(profile).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        ...
                        HashMap<String,Object> adminprof = new HashMap<>();
                        adminprof.put("AdminName",setusername);
                        adminprof.put("AdminPhone",setuserphone);
                        adminprof.put("AdminDob",dobs);
                        adminprof.put("AdminGender",gender);
                        fireAdmin.child("Admin").updateChildren(adminprof).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(EditProfileActivity.this,"Profile updated successfully",Toast.LENGTH_SHORT).show();

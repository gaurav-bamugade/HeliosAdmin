...
public class ApplyForLeavesRejecetedAdapter extends RecyclerView.Adapter<ApplyForLeavesRejecetedAdapter.ViewHolder> {

    Context context;
    ArrayList<LeavesModelClass> leaveModel;

    public ApplyForLeavesRejecetedAdapter(Context context, ArrayList<LeavesModelClass> leaveModel) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.leaveStatusColor.setBackgroundColor(res.getColor(R.color.red));

...
import com.example.adminsidedemoproject.Adapter.GroupChatMessageAdapter;
import com.example.adminsidedemoproject.Model.GroupChatMessages;
    ...
    private void loadGroupChatMsgs()
    {
        ...
        ref.child(groupid).child("Messages").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot)
            {
                ...
                for(DataSnapshot ds:snapshot.getChildren())
                {
                    GroupChatMessages model=ds.getValue(GroupChatMessages.class);
                    groupChatMsg.add(model);
                }
                GroupChatMsgAdapter= new GroupChatMessageAdapter(GroupChatActivity.this,groupChatMsg);
                chat_recycler.setAdapter(GroupChatMsgAdapter);

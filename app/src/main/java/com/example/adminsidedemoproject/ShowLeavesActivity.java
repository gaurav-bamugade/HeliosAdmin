...
import com.example.adminsidedemoproject.Adapter.ApplyForLeavesPastAdapter;
import com.example.adminsidedemoproject.Adapter.ApplyForLeavesRejecetedAdapter;
import com.example.adminsidedemoproject.Adapter.ApplyForLeavesUpcomingAdapter;
                ...
                else
                {
                    try{
                                ...
                                && !dialogue_spinner_string.getText().toString().isEmpty() && !dialogue_enter_reason.getText().toString().isEmpty())
                        {
                           ...
                           /* Timestamp  tstart = new Timestamp(((Date)df.parse(leaveFromDateEditText.getText().toString())).getTime());
                            Timestamp  tend = new Timestamp(((Date)df.parse(leaveToDateEditText.getText().toString())).getTime());*/
